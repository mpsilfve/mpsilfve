...
\begin{equation}
f_{t,z} = \argmax_{y\in Y^T} \prod_{t = 1}^T p(y_t, t \cond x\parcond\theta)
\end{equation}

The forward algorithm is in fact simply a recursive application of the
right distributive rule of algebra
$$(a_1 + ... + a_n)b = a_1 b + ... + a_n b,$$
