...
morphological guessers can be constructed from morphological analyzers
\citep{Linden2009}. These extend the analyzer to previously unseen
...
implemented using the open-source finite-state toolkit HFST\footnote{\url{http://hfst.github.io/}}
\citep{Linden2009hfst} and is utilized for the experiments presented in
...
\cite{Berg-Kirkpatrick2010} propose a model for part-of-speech
